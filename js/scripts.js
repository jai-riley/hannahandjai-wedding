$(document).ready(function () {
    ...
    $(function () {
        $(window).scroll(function () {
            ...
            if (scroll >= 20) {
                ...
                $('header').css({ "border-bottom": "none", "padding": "14px 0" });
                $('header .navicon').css({ "top": "22px" });
            } else {
                $('section.navigation').removeClass('fixed');
                $('header').css({ "border-bottom": "solid 1px rgba(255, 255, 255, 0.2)", "padding": "24px 0" });
    ...
    /********************** Wedding party itinerary unlock ***********************/
    if (localStorage.getItem('weddingParty') === 'true') {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            title: "Hannah & Jai's Wedding",
            start: new Date('Jun 11, 2027 15:00'),
            end: new Date('Jun 13, 2027 11:00'),
            address: 'Mulhurst Camp, Pigeon Lake, Alberta',
            description: "Join us for our wedding weekend at camp! Questions? Email hannahandjai2027@gmail.com"
        }
    });
...
// Google map — Mulhurst Camp, Pigeon Lake, AB
function initMap() {
    var location = {lat: 52.9186, lng: -114.0292};
